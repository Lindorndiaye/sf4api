...
$b->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\EssaieRepository' => function () {
    return ($this->privates['App\Repository\EssaieRepository'] ?? $this->load('getEssaieRepositoryService.php'));
}))));
