...
// Returns the private 'App\Repository\EssaieRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/EssaieRepository.php';

return $this->privates['App\Repository\EssaieRepository'] = new \App\Repository\EssaieRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
